...
Moves1:
	...
	move EFFECT_NORMAL_HIT,         50, BUG,           100, 30,   0      ;CUT
	...
	move EFFECT_NORMAL_HIT,         40, GRASS,         100, 10,   0      ;VINE_WHIP
	...
	move EFFECT_MULTI_HIT,          20, BUG,            95, 20,   0      ;PIN_MISSILE
	...
	move EFFECT_CONFUSE,             0, NORMAL,         70, 20,   0      ;SUPERSONIC
	...
	move EFFECT_FREEZE_HIT,         95, ICE,           100, 15,  10      ;ICE_BEAM
	...
	move EFFECT_RECOIL_HIT,         90, FIGHTING,      100, 25,   0      ;SUBMISSION
	move EFFECT_FLINCH_HIT,         50, FIGHTING,      100, 20,  30      ;LOW_KICK
	...
	move EFFECT_TRAP_TARGET,        15, FIRE,           85, 15,   0      ;FIRE_SPIN
	...
	move EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC_TYPE,  100, 15,  10      ;PSYCHIC_TYPE_M
	move EFFECT_SLEEP,               0, PSYCHIC_TYPE,   75, 20,   0      ;HYPNOSIS
	...
	move EFFECT_NORMAL_HIT,        100, NORMAL,         90, 10,   0      ;EGG_BOMB
	move EFFECT_PARALYZE_HIT,       30, GHOST,         100, 30,  30      ;LICK
	move EFFECT_POISON_HIT,         30, POISON,        100, 20,  30      ;SMOG
	...
	move EFFECT_JUMP_KICK,         130, FIGHTING,       85, 10,   0      ;HI_JUMP_KICK
	...
	move EFFECT_MULTI_HIT,          18, NORMAL,         85, 15,   0      ;FURY_SWIPES
	move EFFECT_DOUBLE_HIT,         50, GROUND,         90, 10,   0      ;BONEMERANG
	move EFFECT_HEAL,                0, PSYCHIC_TYPE,  100, 10,   0      ;REST
	move EFFECT_FLINCH_HIT,         80, ROCK,           90, 10,  30      ;ROCK_SLIDE
	...
	move EFFECT_TRIPLE_KICK,        15, FIGHTING,      100, 10,   0      ;TRIPLE_KICK
	...
	move EFFECT_SNORE,              55, NORMAL,        100, 15,  30      ;SNORE
	...
	move EFFECT_POISON_HIT,         90, POISON,        100, 10,  15      ;SLUDGE_BOMB
	move EFFECT_ACCURACY_DOWN_HIT,  30, GROUND,        100, 10, 100      ;MUD_SLAP
	move EFFECT_ACCURACY_DOWN_HIT, 100, WATER,          85, 10,  50      ;OCTAZOOKA
	...
	move EFFECT_DEFENSE_DOWN_HIT,  120, STEEL,          85, 15,  20      ;IRON_TAIL
	move EFFECT_ATTACK_UP_HIT,      70, STEEL,          95, 35,  10      ;METAL_CLAW
